...
const TermsAndConditionsScreen = () => {
  return (
    <div className="center">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Password Generator &amp; Cipher.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Password Generator &amp; Cipher,
            accessible from{" "}
            <a
              href="passwordgeneratorandcipher.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              passwordgeneratorandcipher.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: michaelgomesweb+support@gmail.com</li>
      </ul>
    </div>
  );
};
